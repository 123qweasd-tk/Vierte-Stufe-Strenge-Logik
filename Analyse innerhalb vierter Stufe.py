...
with open('main_innerhalb_der_Stufe output.csv') as orders_file:
    ...
    for formula in deducable_tetradic_formula_list:
        ...
        if formula[0].count('u') == 0:
            ...
            name_function_prem_3 = function_number_to_name(formula[1][0][2][0], 3)
    ...
    for i, row in enumerate(count_e):
        if row[3][0] == 'Rest':
            print(str(row[2]+1)+' & '+str(row[3][0])+' & '+str(row[1])+' & ('+str(row[4])+') &')

        if row[3][0] == 'Quark':
            print('\cellcolor{lightgray}'+str(row[2]+1)+' & '+str(row[3][0])+' & '+str(row[1])+' & ('+str(row[4])+') &')

        if row[3][0] == 'Gluon':
            print('\cellcolor{gray}'+str(row[2]+1)+' & '+str(row[3][0])+' & '+str(row[1])+' & ('+str(row[4])+') &')
